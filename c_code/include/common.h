...
#define STOP_THRESHOLD 50          // Stop when within 50 counts (~0.2 inches)
...
typedef struct {
    ...
    int is_backing_up;      // 1 if driving backwards to align with bucket
    int isolated_turn;      // 1 if turn was commanded standalone (not part of GOTO)
