...
typedef struct {
    ...
    double vel_l;         // Left encoder velocity (counts/sec)
    double accel_l;       // Left encoder acceleration (counts/sec^2)
    ...
    double vel_r;         // Right encoder velocity (counts/sec)
    double accel_r;       // Right encoder acceleration (counts/sec^2)
    ...
    char nav_controller_mode; // Controller mode: 0=PID, 1=ML
} LogEntry;
